...
## setwd() not used. Instead copied the data folder to assignment directory, for the purpose of generic execution on any local device
##setwd("C:/Users/pushk/Documents/GitHub/DSC520_Forked/dsc520")
...
voter_turnout_df2 <- read_excel('data/G04ResultsDetail2004-11-02.xls', sheet=2, skip=1)
voter_col_names <- c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout")
colnames(voter_turnout_df2) <- voter_col_names
