...
#housing_df <- housing_df1[housing_df1$`Sale Price` > 50000 & #housing_df1$`Sale Price` < 3000000 & housing_df1$square_feet_total_living < #8000, ]

housing_df <- housing_df1
